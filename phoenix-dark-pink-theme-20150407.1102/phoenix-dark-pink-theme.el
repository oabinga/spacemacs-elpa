...
(custom-theme-set-faces
 ...
 ;; '(font-lock-comment-delimiter-face ((t (:weight normal :underline nil :foreground "grey50" :inherit font-lock-comment-face))))
 ;; '(font-lock-comment-face ((t (:foreground "grey60" :underline nil :slant italic :weight normal))))
 ;; '(font-lock-doc-face ((t (:weight normal :underline nil :foreground "gray60" :inherit (font-lock-string-face)))))
 ;; '(font-lock-string-face ((t (:foreground "#df9696" :underline nil :weight normal))))
 ...
 ;; '(font-lock-string-face ((t (:foreground "#907f8f" :underline nil :weight normal))))
